	...
	<div class="container-xl">
		<div class="row g-2 align-items-center">
			<div class="col">
				...
				<h2 class="page-title">Edit Layanan</h2>
			</div>
		</div>
	</div>
</div>
	...
	<div class="container-xl">
		<div class="row">
			<div class="col-md-8 col-lg-6">
				<?= form_open('master/edit_service/' . $service->id, ['class' => 'card']) ?>
				<div class="card-body">
					...
					<div class="mb-3">
						...
						<textarea name="description" class="form-control" rows="3"><?= set_value('description', $service->description) ?></textarea>
					</div>
					<div class="mb-3">
						<label class="form-label">Status</label>
						<label class="form-check form-switch">
							<input class="form-check-input" type="checkbox" name="is_active" value="1" <?= set_checkbox('is_active', '1', $service->is_active == 1) ?>>
