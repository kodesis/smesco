...
<div class="container-fluid p-0">
    <div class="owl-carousel header-carousel position-relative mb-5">
        <div class="owl-carousel-item position-relative">
            <img class="img-fluid" src="<?= base_url() ?>assets/front/img/1.png" alt="">
                ...
                <div class="container">
                    <div class="row justify-content-start">
                        <div class="col-10 col-lg-8">
                            ...
                            <p class="fs-5 fw-medium text-white mb-4 pb-2">Dengan Smesco Express, paket Anda berada di tangan yang aman. Cepat, aman, dan selalu tepat waktu.</p> -->
        ...
        <div class="owl-carousel-item position-relative">
            <img class="img-fluid" src="<?= base_url() ?>assets/front/img/2.png" alt="">
            <div class="position-absolute top-0 start-0 w-100 h-100 d-flex align-items-center">
                <div class="container">
                    <div class="row justify-content-start">
                        <div class="col-10 col-lg-8">
        ...
        <div class="owl-carousel-item position-relative">
            <img class="img-fluid" src="<?= base_url() ?>assets/front/img/3.png" alt="">
            <div class="position-absolute top-0 start-0 w-100 h-100 d-flex align-items-center">
                <div class="container">
                    <div class="row justify-content-start">
                        <div class="col-10 col-lg-8">
                ...
                <div class="container">
                    <div class="row justify-content-start">
                        <div class="col-10 col-lg-8">
                            ...
                            <p class="fs-5 fw-medium text-white mb-4 pb-2">Dari lokal hingga internasional, Smesco Express mengantarkan barang Anda dengan cepat dan handal.</p>
                            <a href="" class="btn btn-primary py-md-3 px-md-5 me-3 animated slideInLeft">Baca Selengkapnya</a>
                            <a href="" class="btn btn-secondary py-md-3 px-md-5 animated slideInRight">Dapatkan Penawaran</a>
                        </div>
                    </div>
        ...
        <div class="row g-5 mx-lg-0">
            <div class="col-lg-6 ps-lg-0 wow fadeInLeft" data-wow-delay="0.1s" style="min-height: 400px;">
                <div class="position-relative h-100">
                    <img class="position-absolute img-fluid w-100 h-100" src="<?= base_url() ?>assets/front/img/smesco-01.png" style="object-fit: ;" alt="">
                </div>
            </div>
            <div class="col-lg-6 about-text wow fadeInUp" data-wow-delay="0.3s">
                ...
                <p class="mb-5">Perusahaan ekspedisi Smesco Express berdiri sejak NOVEMBER 2023. Usaha kami tidak hanya jasa kurir paket DOMESTIK, tetapi juga pada kegiatan PENGIRIMAN barang dan pengiriman dokumen ke luar negeri.</p>
        ...
        <div class="owl-carousel testimonial-carousel wow fadeInUp" data-wow-delay="0.1s">
            ...
            <div class="testimonial-item p-4 my-5">
                ...
                <div class="d-flex align-items-end mb-4">
                    <img class="img-fluid flex-shrink-0" src="<?= base_url() ?>assets/front/img/testimonial-3.jpg" style="width: 80px; height: 80px;" alt="Testimonial 3">
                    <div class="ms-4">
                        <h5 class="mb-1">Rahmat Hidayat</h5>
                        <p class="m-0">Direktur, CV Kargo Nusantara</p>
                    </div>
                </div>
                <p class="mb-0">Sistem pengiriman mereka sangat efisien. Kami berhasil menghemat waktu dan biaya berkat layanan yang diberikan.</p>
            </div>
            <div class="testimonial-item p-4 my-5">
                <i class="fa fa-quote-right fa-3x text-light position-absolute top-0 end-0 mt-n3 me-4"></i>
                <div class="d-flex align-items-end mb-4">
                    <img class="img-fluid flex-shrink-0" src="<?= base_url() ?>assets/front/img/testimonial-4.jpg" style="width: 80px; height: 80px;" alt="Testimonial 4">
                    <div class="ms-4">
                        <h5 class="mb-1">Dewi Lestari</h5>
                        <p class="m-0">Pemilik, Toko Elektronik Makmur</p>
                    </div>
                </div>
                <p class="mb-0">Sangat merekomendasikan perusahaan ini! Pengiriman barang tepat waktu dan kondisi barang selalu terjaga dengan baik.</p>
            </div>
        </div>
    </div>
</div> -->
