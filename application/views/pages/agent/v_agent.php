        ...
        <div class="row g-2 align-items-center">
            ...
            <div class="col-auto ms-auto d-print-none">
                <div class="btn-list">
                    ...
                    <a href=<a href="#" class="btn btn-primary d-none d-sm-inline-block" data-bs-toggle="modal" data-bs-target="#addNewAgent">
                        <!-- Download SVG icon from http://tabler-icons.io/i/plus -->
                        <svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                            <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                            <path d="M12 5l0 14" />
                    ...
                    <a href="#" class="btn btn-primary d-sm-none btn-icon" data-bs-toggle="modal" data-bs-target="#addNewAgent" aria-label="Create new report">
                        <!-- Download SVG icon from http://tabler-icons.io/i/plus -->
                        <svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                            <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                            <path d="M12 5l0 14" />
                            ...
                            <tbody>
                                ...
                                foreach ($agents as $c) : ?>
                                    <tr>
                                        ...
                                        <td><?= $c->nama_agent ?></td>
                                        <td><?= $c->origin ?></td>
                                        <td><?= ($c->telepon_agent) ?></td>
                                        <td><?= $c->alamat_agent ?></td>
                                        <td>
                                            <button type="button" class="btn btn-ghost-primary btn-sm editData" data-id="<?= $c->slug ?>" data-nama="<?= $c->nama_agent ?>">Edit</button>
                                        </td>
                                    </tr>
                                <?php
                                endforeach; ?>
                    ...
                    <div class="row">
                        <div class="col-md-12 col-12">
                            <div class="mb-3">
                                ...
                                <input type="text" name="nama_agent" id="nama_agent" class="form-control" placeholder="Masukkan nama agent...">
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 col-12">
                            <div class="mb-3">
                                <label for="telepon_agent" class="form-label">No. Whatsapp</label>
                                <input type="text" name="telepon_agent" id="telepon_agent" class="form-control" placeholder="Masukkan ...">
                            </div>
                        </div>
                        <div class="col-md-12 col-12">
                            <div class="mb-3">
                                <label for="alamat_agent" class="form-label">Alamat</label>
                                <input type="text" name="alamat_agent" id="alamat_agent" class="form-control" placeholder="Masukkan ...">
                            </div>
                        </div>
                    </div>
